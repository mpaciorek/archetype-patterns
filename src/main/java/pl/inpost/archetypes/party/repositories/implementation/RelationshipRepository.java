...
public class RelationshipRepository extends RepositoryTemplate<PartyRelationship, UUID> implements pl.inpost.archetypes.party.repositories.RelationshipRepository {
