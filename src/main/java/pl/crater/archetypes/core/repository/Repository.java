package pl.crater.archetypes.core.repository;

import pl.crater.archetypes.core.repository.specification.Specification;
 ...
 * @param <I>
 *            The id type of the Base Persistent Model being contained in the
 *            repo.
 */
public interface Repository<E extends BasePersistentModel, I> {
